...
public class CardTest {
    ...
    public void writeWinTest() throws Exception{
        winTests("2"+ filenameTest); //tests if player 1 doesn't win instantly
        winTests(filenameTest); //tests if player 1 does win instantly
    }
    public void winTests(String filename)throws Exception{
        ...
        String whereStored = "w" + filenameTest;
        FileWriter file = new FileWriter(whereStored);
        BufferedWriter bw = new BufferedWriter(file);
        method2.invoke(player1, bw);
        bw.close();
        BufferedReader br = new BufferedReader(new FileReader(whereStored));
